...
<div class="modal-header">
	<div class="category-heading modal-title">Make it delightful</div>
...
<div class="row">
	<div class="col-sm-12">
		<div class="p-3 m-0 bg-light w-100">
			<div class="item-heading"><?php echo $data["item"]->name;?></div>
...
<div class="modal-body">			
				...
				<div class="menu-extra-group">
					...
					<div class="custom-control custom-radio border-bottom py-2">
						<input type="radio" id="extra-<?php echo $mod["id"];?>" name="extra-<?php echo $modifier["id"];?>"
							class="custom-control-input modifier-option" <?php echo ($data["modifier"]==$mod["id"])?"checked":"";?>> <label
		...
		<div class="col-sm-12">
			 ...
			 <div class="menu-extra-container-multi">
		        ...
		        <div class="menu-extra-group-multi border-bottom py-2">
			         <input type="checkbox" id="extra-<?php echo $mod["id"];?>" name="extra-<?php echo $modifier["id"];?>" class="custom-control-input modifier-option"> <label class="custom-control-label" for="extra-<?php echo $mod["id"];?>"><?php echo $mod["name"];?> $<?php echo $mod["price"];?></label>
                     <input type="hidden" id="hdn-extra-<?php echo $mod["id"];?>" value="<?php echo $mod["price"];?>"/>
		        </div>
                <?php } ?>
             </div>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<textarea class="form-control" style="margin-top:5px;" name ="instructions" placeholder="Please inform us of any special requirements when preparing this part of your order --Thank You" id="extra-instructions"></textarea>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-12">
				...
				<div class="extra-price-item">
					...
					<div class="extra-price-item-inner">
                        <div class="number-spinner">
						  ...
						  <input type="text" class="pl-ns-value" value="1" maxlength=2 id="extra-quantity" name="extra-quantity">
						  <span class="ns-btn">

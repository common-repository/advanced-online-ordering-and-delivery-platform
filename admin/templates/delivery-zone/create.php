	...
	<div class="col-12">
		<div class="d-flex">
			<div class="connection-header">
				<h4 class="mb-0">New Delivery Zone</h4>
			</div>
...
<div class="row">
	...
	<div class="col-sm-5">
		<div class="card mb-12">
			...
			<div class="card-body">
        		<form id='create-delivery-zone-form' action='#' method='post'>
        			<table class='table table-hover table-responsive table-bordered' style="width:100%">       
        				...
        				<tr>
        					...
        					<td>
        						<input type='text' id="min-amount" name='min_amount' class='form-control' /> 				
        					</td>
        				</tr>      
        				<tr>
        					<td>Delivery Fee</td>
        					<td>
        						<input type='text' id="delivery-fee" name='delivery_fee' class='form-control' /> 				
        					</td>
        				</tr>      
        				<tr>
        					<td>Region Data</td>
        					<td><textarea id="area-map" name='area_map' class='form-control' readonly="readonly"></textarea></td>
        				</tr>
        
        				<tr>
        					<td></td>
        					<td>
        						<button type='button' class='btn btn-primary' onclick="saveModel('#delivery-content', 'delivery-zone')">
        			...
        			<input type="hidden" id="zone-type" name="zone_type" value="">
        		</form>
        	</div>
        </div>
	</div>

 ...
 */
class Bnd_Flex_Order_Delivery_API_Order_Payment extends Bnd_Flex_Order_Delivery_API_Base
{
    // Here initialize our namespace and resource name.
    public function __construct() {
        parent::__construct();
        $this->table_name="bnd_order_payment";
        $this->model_name="order-payment";
